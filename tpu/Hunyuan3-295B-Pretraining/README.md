...
| FP8（同硬件，**分母 4614**） | — | — | **625 / MFU 13.6%**（64c，开 QAG）；256c 无 QAG 618（DSV3 743.5 / 16.1%） | — |
...
1. **v7 每芯片吞吐约为 v5p 的 4.16 倍**（4,312 vs 1,037，⚠️ **v5p 那个数是 8K 序列下测的，此倍数为高估**），MFU 却更低（25.96% vs 35.07%）——
