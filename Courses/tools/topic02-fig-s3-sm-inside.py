...
t(866, 213, '⭐ 寄存器堆 256 KiB，<tspan font-weight="700">和旁边那块 '
            'L1 ＋ 共享内存一样大</tspan>（也是 256 KiB，其中最多 228 可划给共享）。',
  fill="#174ea6")
t(866, 231, '一块芯片上最贵的 SRAM，整整一半拿去当了「让人待命」的本钱。', fill="#174ea6")
...
t(14, Y3 + 61, '<tspan font-weight="700">代价就是那 256 KiB。</tspan>'
               '「运行时才知道数据什么时候到」——&#160;为这一条付的账里，最贵的一项不是调度器，'
