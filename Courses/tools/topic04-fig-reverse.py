...
⚠️ 这张图里不放任何实测数字。 6,710 亿是 §1.1 已经立过的模型规模，
  其余全是结构，没有量。
"""
...
def main():
    ...
    f.t(CX0, cy + 118, "⛔ 所以它的代价跟<tspan font-weight=\"700\">参数个数</tspan>"
        "成正比。 6,710 亿个参数，就是 6,710 亿遍整条链。", RD, size=13)
    ...
    f.t(CX0, cy2 + 132, "⭐⭐⭐ 走到最左边的时候，"
        "<tspan font-weight=\"700\">6,710 亿个梯度已经全部在手里了</tspan>"
