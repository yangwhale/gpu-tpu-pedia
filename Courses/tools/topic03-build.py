...
<div class="note ok"><p>⭐ <b>2026-09-04 从原来的第七节提到这里，并且展开了一大截。</b> 理由：上一节刚算出 488 GiB 和 32 GiB 两个吓人的数， 不先说清「那个大家伙根本不落地」，后面所有「怎么少算」的讨论都建在恐慌上。 而且顺序反过来讲，逻辑更硬： 「怎么算」这条路已经被走到头了，剩下的省法只能去改「算什么」 —— 三个旋钮正是从这句话长出来的。</p></div>
__FIG_TX_BASE__
...
<p>而且配比正好落回 <b>3 : 1</b>，跟 Kimi Linear、Qwen3.5 一样 —— 换了一家公司、换了搭档层的类型，配比还是那个区间。 这是 §6.2 那句"3:1 到 6:1 这个量级"到目前为止最强的一个旁证。</p></div>
<hr>
</div></section>
