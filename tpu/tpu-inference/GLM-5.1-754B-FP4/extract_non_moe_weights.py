...
into one safetensors file (~21 GB for GLM-5.1 754B).

This file can be placed in /dev/shm alongside the FP4 MoE cache for fast
vLLM startup (~15s vs ~4:30 from many shards on disk).

Usage:
  python3 extract_non_moe_weights.py --model-dir /data/models/GLM-5.1
  python3 extract_non_moe_weights.py --model-dir /data/models/GLM-5.1 --output /data/moe-cache/ep8_tp1_gmm_ep_fp4e2m1_bsNone/non_moe_weights.safetensors
"""
import argparse
import glob
import os
...
def main():
    ...
    parser.add_argument("--model-dir", required=True,
                        help="Path to GLM-5.1 model directory")
