...
<p>这跟"腾讯评估过线性注意力但最终没上"的说法对得上，而且是一手证据。 然后 Hy4 一步跨到全层稀疏 —— 它整个跳过了线性这一支。 对照 §8.2 那张配比表：<b>混合不是唯一解，只是最多人选的那个解。</b></p></div>
...
<p>而且配比正好落回 <b>3 : 1</b>，跟 Kimi Linear、Qwen3.5 一样 —— 换了一家公司、换了搭档层的类型，配比还是那个区间。 这是 §8.2 那句"3:1 到 6:1 这个量级"到目前为止最强的一个旁证。</p></div>
<hr>
</div></section>
