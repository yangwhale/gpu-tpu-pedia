...
def main():
    ...
    f.line(1320, py4 + 92, 80, py4 + 92, PU, 2.6)
    f.t(1330, py4 + 66, "loss 那头", PU, True, 13, "end")
    f.t(90, py4 + 66, "输入那头", PU, True, 13)
    for k in range(6):
        x = 1200 - k * 216
        f.box(x - 54, py4 + 74, 108, 36, "#fff", OR, 5, sw=1.5)
        f.t(x, py4 + 98, "算子 %d" % (k + 1), OR, True, 12.5, "middle")
        f.line(x, py4 + 114, x, py4 + 146, OR, 1.8)
        f.t(x, py4 + 168, "结账", OR, True, 12, "middle")
    ...
    yb = f.band(py4 + PH4 + 18, "ok", "⭐ 这张图的两句话", [
