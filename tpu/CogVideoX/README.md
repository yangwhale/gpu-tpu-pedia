...
> **最后更新**：2025-12-20
> 
> 🎉 **最新进展**：Flax VAE 优化完成！解码时间从 12s 降至 **1.30s**，比 TorchAx (2.37s) 快 **82%**！
...
│ Stage 2: Trans    │   ~162s    │   ~25s     │   ~137s    │ 10步推理     │
│ Stage 3: TorchAx  │   ~129s    │   2.37s    │   ~126s    │ VAE 解码     │
...
| 实现 | 解码时间 | vs TorchAx | 特点 |
|------|----------|------------|------|
| **Flax VAE** 🏆 | **1.30s** | 82% 更快 | 纯 JAX，性能最优 |
| TorchAx VAE | 2.37s | 基准 | PyTorch 兼容，移植容易 |
| Flax VAE (未优化) | ~12s | 5x 更慢 | 无 JIT/分片 |
