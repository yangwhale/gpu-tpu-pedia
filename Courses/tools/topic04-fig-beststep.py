...
def main():
    ...
    yb = f.band(py3 + PH3 + 20, "ok",
                "所以自适应优化器分母上那一项，不是「一个技巧」——　它是二阶导的替身",
                ("⭐⭐⭐ 顺着这条线再看一眼本讲 3.3 那个结论就通了："
                 "<tspan font-weight=\"700\">Adam 把梯度的尺度除掉之后，"
                 "每步大约挪 0.2 × 学习率</tspan>　——　"
                 "它之所以敢把尺度除掉，是因为<tspan font-weight=\"700\">"
                 "那个分母本来就在替二阶导干活</tspan>。",
                 "⛔ 也要知道这个替身<tspan font-weight=\"700\">只是替身</tspan>："
                 "「梯度一直大 ＝ 曲率大」只是个经验假设，它不总成立 ——　"
                 "这正是为什么调参这件事至今还是手艺。"))
