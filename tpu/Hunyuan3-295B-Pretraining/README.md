...
| FP8（同硬件，**分母 4614**） | — | ⚠️ **1,014.8 / MFU 22.0%（存疑，见 TUNING §3.4.8）**<br>**7,308 tok/s/chip**（QAG + dvfs 7 + 18 个 tile 参数）<br><sub>2026-08-15 换 tile 入口，此前 674 / 4,854</sub> | 无 QAG 618 ⚠️ 未按新配方复测 | DSV3 官方 743.5 / 16.1% |
