...
if ! lsmod | grep -q nvidia; then
    ...
    apt-get update -y && apt install nvidia-open-580 -y
...
if ! python3 -c "import deep_ep" &> /dev/null; then
    ...
    # 构建和安装
    NVSHMEM_DIR=/opt/deepep/nvshmem python3 setup.py build
...
echo "All installations completed successfully!"
 ...
 mkdir -p /home/kubernetes/bin/nvidia/lib64
              ...
              # deepep
              cp -r /opt/deepep_build/build/lib.linux-x86_64-cpython-312/* /home/kubernetes/bin/nvidia/deepep
              # bin
