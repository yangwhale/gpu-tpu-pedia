#!/bin/bash
# Qwen3 235B-A22B 256 GPU — STRICT native Bridge recipe (full_iteration graph)
...
# qwen fp8_mx gb300 -> del_cudnn_ln=True -> NVTE_NORM_*_USE_CUDNN NOT set (popped)
export TORCH_NCCL_HIGH_PRIORITY=1
export HF_HUB_OFFLINE=0
export HF_HUB_DISABLE_XET=1
export HF_TOKEN=${HF_TOKEN:-<YOUR_HF_TOKEN>}  # 填入你的 HuggingFace token
...
# (qwen: NVTE_ALLOW_NONDETERMINISTIC_ALGO not set — that's deepseek-only)
