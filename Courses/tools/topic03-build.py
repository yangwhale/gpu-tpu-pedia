...
<ul><li><b>第一版</b>：把 K 和 V 切给 4 个 warp，Q 大家共用（叫 sliced-K）。 ⛔ 于是每个 warp 都得把中间结果写进共享内存、同步、再加起来 ——&nbsp; 这些读写拖慢了前向。</li><li><b>第二版</b>：反过来，把 <b>Q 切给 4 个 warp</b>，K 和 V 大家共用。 ⭐ 每个 warp 算出自己那一片 <code>QKᵀ</code>，直接乘共享的那片 V 就得到自己那片输出 ——&nbsp;<b>warp 之间完全不需要通信。</b></li></ul>
...
<tr><td><b>Kimi K3</b></td><td><b>93 层 ＝ 23 × (3 KDA ＋ 1 Gated MLA) ＋ 1 MLA</b> ——&nbsp;循环配比 <b>3 : 1</b>，实际层数 69 : 24。<em>⚠️ 别写成「69 : 24 = 3 : 1」，一除就是 2.875</em></td><td>arXiv 2607.24653 表 1 ＋ sec. 2.1</td></tr>
...
<p>⭐ <b>三件事要讲清楚：</b></p>
<ol><li><b>3:1 是消融出来的，不是推出来的。</b> Kimi Linear 的消融里， <b>0:1（纯全注意力）反而表现不好</b>（⚠️ 原文只有这一句定性描述，没公开数值）—— 这个结果比"3:1 最好"更有意思： 加线性层不只是省钱，<b>它可能还带来了别的东西</b></li><li><b>同一家不同规模就换了配比</b>（Ling 的 tiny 3:1 / flash 5:1）—— <b>配比是超参，跟规模和数据有关，不要背下来当常识</b></li><li><b>区间比点值可信。</b> 记 "3:1 到 6:1 这个量级" 就够了</li></ol>
...
<li><b>省显存 ≠ 省时间。</b> MLA 对 MHA，显存 <b>56.9×</b>，
  单用户 decode 只有 <b>7.08×</b> ——&nbsp;<em>因为 MHA 装不下，被迫多用了卡，
  而多出来的卡顺手也带来了带宽。所以 MLA 真正省下的不是时间，<b>是那 5 张卡</b>。</em></li>
