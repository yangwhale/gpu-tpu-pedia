...
lec("X0", "开场", "这十五分钟要回答两件事", 1, "开场：两件事",
  ...
  <div class="say">
    ...
    <p>开始之前先说清一件事：<b>这十五分钟我不给你们比 benchmark，一个快慢数都没有。</b>
...
lec("X1", "一", "同一把尺子，量四颗芯片", 2, "一：四颗芯片，一个异类",
...
''')
    ...
    assert total == 15, "主线合计 %d 分钟 —— 目标 15，超了就砍，少了就补" % total
