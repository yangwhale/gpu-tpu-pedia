...
⭐ Ⓑ 是这张图真正的落点，而且它是**算出来的，不是画出来的**：
  ...
  · 一条 128K 序列、开了重算的**峰值** ＝ 106.75 ＋ 55.39 ＝ 162.14 GiB
...
ACT_ONE_SEQ_GIB = 106.75 + 55.39    # 一条 128K：存档点 ＋ 在算层 ＝ 162.14
...
assert 60 < CROSSOVER < 63       # T04 修正峰值口径 94→56；T09 派发九份作废后 56→61
