...
| **MFU** | 35.07% | **28.71%** | 25.96% ⚠️ | 34.16% ⚠️ |
...
> GB300 NVL72 的官方 BF16 dense 峰值与 GB200 NVL72 相同，都是 **2,500**，所以同一个 854.0 对应 **34.16%**。
> ⚠️ **2026-09-01 再修一处**：此前这里写 34.20%，但 `854.0 ÷ 2,500 ＝ 34.16%`；34.20% 反推回去是 855.0，与全仓一致使用的 854.0 对不上。已统一为 **34.16%**（约等于 34.2%）。
