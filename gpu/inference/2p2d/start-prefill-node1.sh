#!/bin/bash
#
# SGLang DeepSeek-V3 Prefill Node 1 (2P+2D with DeepEP)
# Run on: b8 (10.8.0.17)
#
...
# Configuration - Note: DIST_INIT_ADDR points to Prefill master (b7)
PREFILL_MASTER_IP="10.8.0.12"  # b7 is the prefill master
DIST_INIT_ADDR="${PREFILL_MASTER_IP}:5757"
...
INIT_EXPERT_LOCATION="${INIT_EXPERT_LOCATION:-/lssd/huggingface/attachment_ep_statistics/prefill_in4096.json}"

echo "============================================="
echo "SGLang 2P+2D Prefill Node 1 (b8)"
echo "============================================="
