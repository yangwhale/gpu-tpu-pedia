# -*- coding: utf-8 -*-
r"""专题三 · §4.2b「事后压 vs 从头按压缩训」（2026-09-13 R10 ／ 2026-09-14 降级）。
...
def main():
    ...
    f = Fig(W, "事后压 vs 从头按压缩训：这条对立在四个分支上"
               "各出现一次，它跟三个旋钮正交，两轴一交叉就成了一张地图")
    f.marks = set()
    y0 = f.header(
        "一条反复出现的判据　——　事后压，还是从头按压缩训",
        "⭐⭐ 这条对立今天<tspan font-weight=\"700\">会出现四次</tspan>，四次在四个不同的分支上"
        " ——&#160;⚠️ 但<tspan font-weight=\"700\">四次全在旋钮①② 上，旋钮③ 一格都没有</tspan>"
        "（为什么留空见 §4.2b）",
