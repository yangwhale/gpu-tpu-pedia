"""RRDBNet architecture for Real-ESRGAN (standalone, no basicsr dependency).

Extracted from basicsr.archs.rrdbnet_arch to avoid import chain issues
with torchvision compatibility.
...
class RRDBNet(nn.Module):
    ...
    For scale=4: direct input, two 2x upsamples via F.interpolate(nearest).
