#!/bin/bash
#
# SGLang DeepSeek-V3 Decode Node 1 (2P+2D with DeepEP)
# Run on: b10 (10.8.0.19)
#
...
# Configuration - Note: DIST_INIT_ADDR points to Decode master (b9)
...
echo "============================================="
echo "SGLang 2P+2D Decode Node 1 (b10)"
echo "============================================="
