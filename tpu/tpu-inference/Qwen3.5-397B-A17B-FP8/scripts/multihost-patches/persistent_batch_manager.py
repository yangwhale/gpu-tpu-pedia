    ...
    def update_states(self, scheduler_output: "VllmSchedulerOutput",
        ...
        for new_req_data in scheduler_output.scheduled_new_reqs:
            ...
            if self.uses_mrope:
                ...
                # PATCH: skip mrope fn call if fn is None (user disabled mm via --limit-mm-per-prompt)
                # Pairs with tpu_runner.py patch that sets get_mrope_input_positions_fn=None
                if get_mrope_input_positions_fn is None:
                    continue
