...
| **v7 FP8 调优** | 当前 **618**（对 FP8 峰值 4614 是 MFU 13.4%），DSV3 同口径 **743.5 / 16.1%**，落后 20.3%。**FP8 走的是另一条 GMM kernel，那条路的 tile 完全没调过**（tile 在 BF16 路径值 +17.4%）。潜力约 726，是当前最大的一块空白。见 [TUNING-v7 §5](TUNING-v7.md#5-fp8跑通了但一格都还没调) |
