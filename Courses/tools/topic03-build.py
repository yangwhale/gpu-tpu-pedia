...
<div class="note info"><p>📌 <b>DSA 的打分式子值得念一遍</b>：
  ...
  头很少，而且<b>跑在 FP8 上</b>；<code>k = 2048</code>。</p></div>
...
<ul><li><b>delta rule 不是 2024 年的东西</b>，是 Schlag 等 2021 年那篇 <em>Linear Transformers Are Secretly Fast Weight Programmers</em>（可上溯到 1990 年代的 fast weight programmer）。2024 年那篇（arXiv 2406.06484）做的是 <b>把它并行化</b>，这是另一件事、也是很关键的一件事 —— 见 §7.2</li><li><b>KDA 是 2025 年 10 月的 Kimi Linear</b>，不是 2026 年</li></ul>
...
<p>⭐ 所以这张表不是「表达力越来越强」的单调故事。<b>每一步都在「A 能多复杂」和「还算不算得动」之间重新划线</b>—— 这正是 §7.2 那句「表达力和可算性是一起设计的」的完整版。</p></div>
