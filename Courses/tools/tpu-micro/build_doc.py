...
我们这次的语言模型是 131,072 ÷ 129,280 ≈ <b>1.01</b> ——
...
<tr><td>duplication factor<br>（§5）</td><td>131,072 ÷ 129,280 ≈ 1.01</td>
<td>一批取了多少个索引 ÷ 可选的行数。语言模型几乎每个位置取的都是不同的词，
所以贴着 1 —— 这正是 SparseCore <b>最不划算</b>的那一端</td></tr>
