...
| **想在 v7 (Ironwood) 上跑** | **[QUICKSTART-v7.md](QUICKSTART-v7.md)** —— 只管跑起来拿到基线：拿机器的方式、单位换算、当前水位 |
| **想把 v7 调快** | **[TUNING-v7.md](TUNING-v7.md)** —— 从基线往下走：为什么只有 19.29%、已经试过什么（含三条死路）、roofline 分析、实验清单。**活文档，跑一轮回填一行** |
