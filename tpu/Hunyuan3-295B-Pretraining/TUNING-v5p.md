...
| **R16** | **tokamax + LUT 补丁**（专家数 192 镜像 128 的调优 tile） | 🔄 **进行中** —— 根因见 [§2.6](#26-打开盒子不跨代的机理落到了一张查找表上) |
| R17 | 对 192 分组真跑一次 `tokamax.autotune` | ⬜ 仅当 R16 证明方向对、但收益不及预期时才做 |
