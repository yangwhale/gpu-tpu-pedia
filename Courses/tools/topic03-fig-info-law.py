...
def main():
    ...
    f.t(px(6), py_(math.exp(-5 / 40.0)) - 16, "只记上一句", RD, True, 19)
    f.t(px(6), py_(math.exp(-5 / 40.0)) + 8, "隔几十句就归零", RD, size=15)
    ...
    f.t(120, by + 216, "⭐⭐ 于是 L2M 那条定理，说人话就是这一句：", PU, True, 22)
