...
# ---- A 组：从 V4 冠军配置单项消融 ----
"A1_V4_champion|$V4"
"A2_no_cutedsl|--cuda-graph full_iteration --a2a-overlap --recompute-granularity none --recompute-modules --no-paged-stash"
"A3_no_a2a_overlap|--cuda-graph full_iteration --cutedsl --recompute-granularity none --recompute-modules"
"A4_no_paged_stash|$V4 --no-paged-stash"
"A5_no_router_fusion|$V4 --no-router-fusion"
"A6_no_permute_fusion|$V4 --no-permute-fusion"
"A7_dispatcher_alltoall|--cuda-graph full_iteration --cutedsl --a2a-overlap --recompute-granularity none --recompute-modules --dispatcher alltoall"
"A8_graph_none|--cuda-graph none --cutedsl --a2a-overlap --recompute-granularity none --recompute-modules"
"A9_graph_TE|--cuda-graph transformer_engine --cutedsl --a2a-overlap --recompute-granularity none --recompute-modules"
"A10_no_force_lb|$V4 --no-force-load-balancing"
"A11_recompute_selective|--cuda-graph full_iteration --cutedsl --a2a-overlap --recompute-granularity selective --recompute-modules moe_act"

# ---- B 组：并行/批次（追 854 vs Qwen3 1360 的差距）----
"B1_vpp2|--cuda-graph full_iteration --cutedsl --a2a-overlap --recompute-granularity none --recompute-modules|--vpp 2"
"B2_vpp4|--cuda-graph full_iteration --cutedsl --a2a-overlap --recompute-granularity none --recompute-modules|--vpp 4"
"B3_pp4_ep16|--cuda-graph full_iteration --cutedsl --a2a-overlap --recompute-granularity none --recompute-modules|--pp 4 --vpp 4 --ep 16"
"B4_ep16|--cuda-graph full_iteration --cutedsl --a2a-overlap --recompute-granularity none --recompute-modules|--ep 16"
"B5_mbs2_TEgraph|--cuda-graph transformer_engine --cutedsl --a2a-overlap --recompute-granularity none --recompute-modules|--mbs 2 --gbs 4096"
"B6_mbs2_pp4|--cuda-graph full_iteration --cutedsl --a2a-overlap --recompute-granularity none --recompute-modules|--pp 4 --vpp 4 --ep 16 --mbs 2 --gbs 4096"
"B7_gbs4096_TEgraph|--cuda-graph transformer_engine --cutedsl --a2a-overlap --recompute-granularity none --recompute-modules|--gbs 4096"
"B8_gbs1024|$V4|--gbs 1024"

# ---- C 组：精度 ----
"C1_fp8_mx|$V4|--precision fp8_mx"
"C2_fp8_mx_mbs2|--cuda-graph full_iteration --cutedsl --a2a-overlap --recompute-granularity none --recompute-modules|--precision fp8_mx --mbs 2 --gbs 4096"

# ---- D 组：规模隔离（减半层数，验证是不是权重太大限制批次）----
"D1_40layer|$V4|--num-layers 40"
"D2_40layer_mbs2|$V4|--num-layers 40 --mbs 2 --gbs 4096"
"D3_40layer_mbs4|$V4|--num-layers 40 --mbs 4 --gbs 8192"
)
