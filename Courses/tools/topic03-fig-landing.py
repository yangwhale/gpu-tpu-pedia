...
def main():
    ...
    #      而我们自己在 v7 上量到的是：同样 seq=4096，splash attention
    ...
    yy = f.src(yy + 16,
               ...
               # ⛔ 原文写的是「本讲 §3.6 量到」。R60 把 §三 整节移交专题二之后
               #   那个号不存在了 ——&#160;⭐ 这时候**不能只删号了事**：号本来
               #   就是这几个数的出处凭证，删了号就得**把测量条件写进正文**。
               "同样 seq=4096，我们在 v7 上实测（Hunyuan3-295B · 64 芯片 · "
               "XProf op stats 页）splash attention "
