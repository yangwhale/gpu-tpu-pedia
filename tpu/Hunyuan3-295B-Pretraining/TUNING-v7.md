...
#### 3.4.8 ⚠️ 未决：native 路径存在正确性疑点，先别照着改生产配置

> 2026-08-15 20:35。**本节是一个未收敛的调查记录，不是结论。**
> 上面 3.4.6/3.4.7 报的 FP8 +49.9%（1,014.8 per-chip）**可能建立在一个算少了的实现上**。
> 在长跑对拍之前，**不要把 FP8 的生产配方改成 native**。
