...
| # | 硬件 | 分辨率 | 帧数 | DP | Block Size | 每步时间 | 10步总时间 | 说明 |
|---|------|--------|------|-----|------------|----------|-----------|------|
| 6 | v6e-8 | 768×1360 | 81 | ✗ | Wan2.1 | 1.50s | 16.55s | 8 chips |
| 7 | v6e-8 | 640×1280 | 61 | ✗ | Wan2.1 | 0.71s | 7.86s | 8 chips，低分辨率 |
| 8 | **v6e-4** | **640×1280** | **61** | ✗ | Wan2.1 | **1.07s** | **11.73s** | **4 chips** |

> **注意**: No-CFG 模式下 batch_size=1（无 negative prompt 分支），无法使用 DP 分片。
> 相比 CFG 模式（25.36s），No-CFG 768×1360×81 快约 **35%**，因为计算量减半。
>
> **4 卡 vs 8 卡性能**：640×1280×61 分辨率下，4 卡 (11.73s) 比 8 卡 (7.86s) 慢约 **49%**，接近线性扩展。
