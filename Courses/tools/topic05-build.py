...
''' + sec("s二", "二", "第一刀：切数据") + '''
  ...
  <p>像几个人合写一本书，每人手里都放着一整本书稿：谁也不缺，可每人的书架都被同一本书占满。下面一节一节把重复的清掉。</p>
...
__FIG_BF16_BETA__
  ...
  <p>回到合写书：现在每人只保管其中几章的原稿。要用哪一章，就把别人那几章<b>复印</b>一份凑齐，用完把复印件扔掉 —— 原稿一直在保管人手里，谁也没少。
    保管的是分片，复印凑齐就是 AllGather，用完扔掉就是只留自己那份；反向算完，大家对每一章的修改意见交给那一章的保管人合并，就是 ReduceScatter。每人都放一整本，就是数据并行。</p>
__FIG_FSDP_STEP__
