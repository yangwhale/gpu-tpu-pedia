...
# ──────────────────────────────────────────────────────────────────────
lec("L1", "01", "先架量具：两边的胃口一样大", 5, "先架量具：胃口一样大",
    grp="立尺子 · 5 分钟", html='''
  <div class="goal">
    <span class="k">这一讲要留下什么</span>
  ...
  <div class="say">
    ...
    <p>好，尺子架完了，也会用了。两个刻度：<b>312 这个数</b>，和<b>三格这个筛子</b>。
    下面第 2 节第一件事，就是拿注意力<b>当场走一遍刚才这个流程</b>
    ——&nbsp;而且你会看到，同一个注意力，<b>两种写法的强度差一千倍</b>。</p>
  </div>
  ...
  <div class="tip">
    <span class="k">节奏提示</span>
    <b>五分钟，两张图 ＋ 两行算术。这一讲有两个重点，不是一个。</b><br>
