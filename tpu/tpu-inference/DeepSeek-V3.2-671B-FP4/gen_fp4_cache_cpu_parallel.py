...
Usage:
  python3 gen_fp4_cache_cpu_parallel.py --model-dir /dev/shm/DeepSeek-R1 --workers 8
  python3 gen_fp4_cache_cpu_parallel.py --model-dir /dev/shm/DeepSeek-R1 --cache-dir /dev/shm/fp4-cache --workers 4
"""
import argparse
import gc
import json
...
def process_layer(args):
    ...
    # Process w13 first (bigger: 256×4096×7168), free before w2
    ...
    # Process w2 (smaller: 256×7168×2048)
...
def main():
    ...
    parser.add_argument("--model-dir", default="/dev/shm/DeepSeek-R1",
                        help="Path to DeepSeek-R1 safetensors (default: /dev/shm)")
    parser.add_argument("--cache-dir", default=None,
                        help="Cache output dir (default: /data/moe-cache-fp4-cpu/...)")
    parser.add_argument("--workers", type=int, default=8,
                        help="Parallel workers (default: 8)")
    parser.add_argument("--force", action="store_true",
                        help="Regenerate all 58 layers")
    ...
    n_out = len([d for d in os.listdir(args.cache_dir)
                 if d.startswith("model_layers_")])
    print(f"\n{'='*60}")
    print(f"Done: {n_out}/58 layers cached")
