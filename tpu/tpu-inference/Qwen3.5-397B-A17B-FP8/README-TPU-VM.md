...
|---:|---:|---:|---:|
| P1 | 20.6 s | 49.6 tok/s | 49.6 |
| P4 | 21.9 s | 186.8 | 46.7 |
| P16 | 25.6 s | 640 | 40.0 |
| P64 | 43.2 s | 1510 | 23.6 |
| **P128** | 61.8 s | **2097 tok/s** | 16.4 |

> **Peak 是 P128**（不是 P256）。P256 throughput 反降到 1877 tok/s，因 scheduler preempt 抖动。
...
> **首次请求延迟**：第一次请求会触发 XLA 编译，Prefill 和 Decode 各需约 1~2 分钟。后续请求命中编译缓存，延迟降到秒级。
