...
⛔⛔ **光写作者名不够 ——&nbsp;2026-09-14 R60 又栽了一次，而且是被「删别的东西」炸出来的。**
   ...
   **闸门一直是绿的，但绿得毫无道理。** R60 把 §三 整节删掉，五处当场全红。
   ...
   ⛔ **R61 又把 §三 整节接回来了，所以现在这五处即便写回原样也不会报警。**
     ⭐ 这条改动照样保留 ——&nbsp;**它本来就不该靠「本课碰巧也有 §3.2」过关。**
     判据能不能通过，和写法对不对，是两件事。
...
def fig_flow():
    ...
    yy = f.band(yy + 14, "info", "两个最常被跳过的「为什么」", [
        ...
        '——&#160;去图书馆找书：<tspan font-weight="700">你脑子里那个需求</tspan>（q）'
        '跟<tspan font-weight="700">书脊上印的标题</tspan>（k）不是同一个东西。',
        '⭐ 那 v 为什么还要跟 k 再分一次？<tspan font-weight="700">k 是书脊，v 是书里的内容</tspan>'
        '——&#160;「凭什么被选中」和「被选中之后交出什么」，本来就是两回事。',
