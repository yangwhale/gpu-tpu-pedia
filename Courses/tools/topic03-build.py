...
__FIG_MHA_FLOW__
<div class="note info"><p>⭐⭐ <b>这张图想让你带走的就一句：一层注意力 ＝ 一次「全员报价、按需取货」。</b>
  <br>而且<b>不只是最后那个 token 在做</b> ——&nbsp;<b>每个位置同时在做同样的事</b>。
  所以一层过后，<b>每个位置的向量都变成了「全场的一个加权视角」</b>；
  堆 L 层，就是把这件事重复 L 次。<br>
  ⛔ <b>「Attention Is All You Need」这个标题最常被读反</b>：
  它说的<b>不是「注意力很强」</b>，而是<b>「混合序列信息这件事，只要它就够了」</b>
  ——&nbsp;<b>循环不需要，卷积也不需要</b>。</p></div>
