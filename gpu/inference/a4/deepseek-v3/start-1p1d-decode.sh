#!/bin/bash
#
# SGLang DeepSeek-V3 Decode Node (1P+1D, single-node per role)
# Run on: b8 (10.8.0.17)
...
echo "============================================="
echo "SGLang 1P+1D Decode Node (b8)"
echo "============================================="
echo "tp-size:         8"
echo "dp-size:         1"
echo "Transfer:        nixl"
...
echo ""
echo "IMPORTANT: Wait for Prefill node to be fully started first!"
echo ""
