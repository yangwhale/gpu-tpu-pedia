...
| FP8（同硬件，**分母 4614**） | — | ✅ **1,014.8 / MFU 22.0%**<sub>（32 步 loss 对拍已定案，见 TUNING §3.4.8）</sub><br>**7,308 tok/s/chip**（QAG + dvfs 7 + 18 个 tile 参数）<br><sub>2026-08-15 换 tile 入口，此前 674 / 4,854</sub> | 无 QAG 618 ⚠️ 未按新配方复测 | DSV3 官方 743.5 / 16.1% |
...
| **v7 FP8 + QAG** | ✅ **已收敛**（2026-08-15 换 tile 入口后再 +50%，到 1,014.8）。64 芯片开 QAG 后 **625**（vs 无 QAG 594，+5.3%）；256 experts 探索到 **645**。<br>⚠️ 原先记的「FP8 那条 kernel 的 tile 完全没调过、潜力 726」**已被实测证伪** —— FP8 内部仍走 tokamax，tile monkeypatch 一直生效。<br>2026-08-05 又扫了 tile / XLA flag / SparseCore 卸载 / 推 batch 共 8 格，**无一正收益**：调参空间已见底，再往上要加卡、改模型形状或写代码。见 [TUNING-v7 §4.6](TUNING-v7.md#46-什么能调什么不能调--一张总表) |
