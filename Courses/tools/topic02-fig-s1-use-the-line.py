...
📌 图上每个数都能当场复核：
   · 向量加 bf16：读 a 2 B ＋ 读 b 2 B ＋ 写 y 2 B ＝ 6 B；乘加 1 次 → 1/6 ＝ 0.17
   · 312 ÷ 0.167 ＝ 1,872 倍
   · 跑满 8 TB/s → 8e12 ÷ 6 ＝ 1.33 TFLOPS；1.33 ÷ 2,500 ＝ 0.053%（万分之五）
   · 方阵乘 bf16：2N³ ÷ 6N² ＝ N/3；N/3 ＝ 312 → N ＝ 937；N ＝ 256 → 85.3
   · 片上那条线 64 的推导链在 fig1-4 下半段；312 ÷ 64 ＝ 4.9 倍
"""
import io
...
t(x + 218, CY + 112, '次乘加', "svglbl", RD, 13)
