...
> 详见 [TUNING-v7 §5](TUNING-v7.md#5-fp8跑通了但一格都还没调)。
...
| **FP8 待调优** | 256 芯片实测 **618**（对 FP8 峰值 4614 是 MFU **13.4%**；+3.2% vs BF16），DSV3 同口径是 743.5 / 16.1%。**那条 kernel 路径的 tile 一次都没扫过**，潜力约 726。见 [TUNING-v7 §5](TUNING-v7.md#5-fp8跑通了但一格都还没调) |
