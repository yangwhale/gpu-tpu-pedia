...
<p class="landing">⭐⭐⭐ <b>那 12 个 fp32 字节，装的正好就是三个「要累加的」；
  两个 bf16 字节，装的正好是两个「一次性的」。</b>
...
<p class="landing">⭐⭐⭐ <b>所以顺序不是随意的，也不是历史巧合 ——&nbsp;
  它是「大小」和「被用到的频率」这两个量排出来的。</b></p>
<p><span class="sub">📌 出处：Rajbhandari 等，<b>ZeRO: Memory Optimizations
  Toward Training Trillion Parameter Models</b>，<b>arXiv 1910.02054</b>。
...
<p class="landing">⭐⭐ <b>所以这几个名词不是「几种优化技巧」，
  是<u>同一张账单上的四个不同栏目各自的对策</u>。</b>
