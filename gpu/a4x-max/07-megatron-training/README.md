...
| FP8 峰值算力 | **5,000 TFLOP/s** | **5,000 TFLOP/s**（不变） | 见下方更正 |
| BF16 峰值算力 | **2,500 TFLOP/s** | **2,500 TFLOP/s**（不变） | 见下方更正 |
| dense FP4 算力 | 10 PFLOPS/GPU | **15 PFLOPS/GPU** (+50%) | Blackwell Ultra 真正提升的那一项 |
| attention 性能 | 1× | **2×**（官方口径） | 另一项真正提升 |
