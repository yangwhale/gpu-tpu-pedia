...
> ### 📘 要端到端复现整套测试？→ [**RUNBOOK-16chip.md**](./RUNBOOK-16chip.md)
>
> 16 chip / 18 格性能矩阵的完整操作手册。每步都有「命令 → 期望输出 → 不对时怎么办 → 耗时」，
> 面向**从没碰过 TPU 的人**，照做即可，不需要自己排查问题。约 2 小时 20 分。
>
> ### 🚀 只想在 4 芯片上跑出第一个数字？→ [**QUICKSTART.md**](./QUICKSTART.md)
>
