...
════════════════════════════════════════════════════════════════
现场定的边界（2026-09-05）：「我们是不是有一个专题专门讲并行方案的？
...
#    现场反馈：「这个画的太垃圾，网上都有非常经典的图，左边至少应该画出 18 条、配 18 台交换机。」
#    旧版**把这套拓扑最要紧的事实画丢了**：
...
# ⛔⛔ 2026-09-05 第四版。第三版只把**一颗** GPU 的 18 条画满，现场否掉：
...
# ⛔⛔ 2026-09-05 第四版。第三版用 2:1 等轴测，现场反馈：「实在是太丑陋了。」
