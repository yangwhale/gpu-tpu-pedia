...
##### 验证实验五：pdbs 11（2026-08-05，进行中）

U1 只差 1.88 G，按 HBM 两参数模型每档 pdbs 约 4.4 G，降一档应落到 92 G 出头。
V1 = `256e / FSDP128 / QAG / pdbs 11`，若跑通，**这将是第一个在完整 80 层上跑起来的 QAG**。
配 V2（同配置关 QAG）取净收益，另加 V3/V4 给 192 留 pdbs 8 的保底。
